...
inline constexpr auto MAX_RECS_X = 800 / RECS_WIDTH;
inline constexpr auto MAX_RECS_Y = 450 / RECS_HEIGHT;

inline constexpr auto PLAY_TIME_IN_FRAMES = 240; // At 60 fps = 4 seconds
