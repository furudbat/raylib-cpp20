...
int main() {
    ...
    raylib::Vector2 fontPosition1{
        {.x = screenWidth / 2.0f - font1.MeasureTextWithBaseSize(msg1, -3).x / 2.0f,
         .y = screenHeight / 2.0f - static_cast<float>(font1.GetBaseSize()) / 2.0f - 80}};

    raylib::Vector2 fontPosition2{
        {.x = screenWidth / 2.0f - font2.MeasureTextWithBaseSize(msg2, -2).x / 2.0f,
         .y = screenHeight / 2.0f - static_cast<float>(font2.GetBaseSize()) / 2.0f - 10}};

    raylib::Vector2 fontPosition3{
        {.x = screenWidth / 2.0f - font3.MeasureTextWithBaseSize(msg3, 2).x / 2.0f,
