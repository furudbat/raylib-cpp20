...
int main(void) {
    ...
    model.SetMaterialShader(
        0,
        shader,
        raylib::ModelMaterialShaderOption::UnbindShader); // Set shader effect to 3d model
    model.SetMaterialMapTexture(
        0,
        MATERIAL_MAP_DIFFUSE,
        texture,
        raylib::ModelMaterialTextureOption::NoUnload); // Bind texture to model
