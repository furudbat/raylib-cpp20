...
int main() {
    ...
    while (!window.ShouldClose()) { // Detect window close button or ESC key
        ...
        cubeScreenPosition =
            ::GetWorldToScreen(::Vector3{cubePosition.x, cubePosition.y + 2.5F, cubePosition.z}, camera);
        //----------------------------------------------------------------------------------
        ...
        //----------------------------------------------------------------------------------
        {
            ...
            raylib::DrawText(
                "Enemy: 100 / 100",
                static_cast<int>(cubeScreenPosition.x - static_cast<float>(::MeasureText("Enemy: 100/100", 20)) / 2.0F),
                static_cast<int>(cubeScreenPosition.y),
                20,
                BLACK);
            raylib::DrawText(
