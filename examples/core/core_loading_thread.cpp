...
int main() {
    ...
    raylib::Window window(ScreenWidth, ScreenHeight, "raylib [core] example - loading thread");
        ...
        BeginDrawing();
        {
            ...
            switch (state) {
                ...
                case State::StateLoading:
                    ...
                    if ((framesCounter / 15) % 2 == 0) raylib::DrawText("LOADING DATA...", 240, 210, 40, DARKBLUE);
                    break;
                case State::StateFinished:
