...
SetOffset(int offsetX = DefaultSetOffsetX, int offsetY = DefaultSetOffsetY) noexcept {
...
[[maybe_unused]] RLCPPAPI_INLINE void
SetScale(float scaleX = DefaultSetScaleX, float scaleY = DefaultSetScaleY) noexcept {
