...
inline constexpr ShaderLocationIndexT MapAlbedo{
    15}; // Shader location: sampler2d texture: albedo (same as: MAP_DIFFUSE)
inline constexpr ShaderLocationIndexT MapMetalness{
    16}; // Shader location: sampler2d texture: metalness (same as: MAP_SPECULAR)
