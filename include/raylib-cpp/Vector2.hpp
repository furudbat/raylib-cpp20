...
public:
    ...
    constexpr Vector2(float _x, float _y)
        : ::Vector2{_x, _y} {}
    [[deprecated("Use Vector2(vec)")]]
    explicit constexpr Vector2(float _x)
        : ::Vector2{_x, 0} {}
    ...
    */
     ...
     */
    [[nodiscard]] Vector2 Add(::Vector2 vector2) const { return ::Vector2Add(*this, vector2); }
     ...
     */
    [[nodiscard]] Vector2 Subtract(::Vector2 vector2) const { return ::Vector2Subtract(*this, vector2); }
     ...
     */
    [[nodiscard]] Vector2 Multiply(::Vector2 vector2) const { return ::Vector2Multiply(*this, vector2); }
     ...
     */
    [[nodiscard]] Vector2 Scale(float scale) const { return ::Vector2Scale(*this, scale); }

    /**
     * Scale vector (multiply by value)
     */
    Vector2 operator*(float scale) const { return ::Vector2Scale(*this, scale); }
     ...
     */
    [[nodiscard]] Vector2 Divide(::Vector2 vector2) const { return ::Vector2Divide(*this, vector2); }
     ...
     */
    [[nodiscard]] constexpr Vector2 Divide(float div) const { return Vector2{::Vector2{x / div, y / div}}; }

    /**
     * Divide vector by value
     */
    constexpr Vector2 operator/(float div) const { return Divide(div); }
     ...
     */
    [[nodiscard]] Vector2 Transform(const ::Matrix& mat) const { return ::Vector2Transform(*this, mat); }

    /**
     * Calculate linear interpolation between two vectors
     */
    [[nodiscard]] Vector2 Lerp(::Vector2 vector2, float amount) const { return ::Vector2Lerp(*this, vector2, amount); }

    /**
     * Calculate reflected vector to normal
     */
    [[nodiscard]] Vector2 Reflect(::Vector2 normal) const { return ::Vector2Reflect(*this, normal); }
     ...
     */
    [[nodiscard]] float DotProduct(::Vector2 vector2) const { return Vector2DotProduct(*this, vector2); }

    /**
     * Calculate distance between two vectors
     */
    [[nodiscard]] float Distance(::Vector2 vector2) const { return Vector2Distance(*this, vector2); }
     ...
     */
    [[nodiscard]] float Angle(::Vector2 vector2) const { return Vector2Angle(*this, vector2); }
    ...
    void DrawPixel(::Color color = DefaultDrawColor) const { ::DrawPixelV(*this, color); }

    void DrawLine(::Vector2 endPos, ::Color color = DefaultDrawColor) const { ::DrawLineV(*this, endPos, color); }
     ...
     */
    void DrawCircle(float radius, ::Color color = DefaultDrawColor) const { ::DrawCircleV(*this, radius, color); }

    void DrawRectangle(::Vector2 size, ::Color color = DefaultDrawColor) const { ::DrawRectangleV(*this, size, color); }
     ...
     */
    [[nodiscard]] bool
    CheckCollisionLines(::Vector2 endPos1, ::Vector2 startPos2, ::Vector2 endPos2, ::Vector2& collisionPoint)
        const noexcept {
        return ::CheckCollisionLines(*this, endPos1, startPos2, endPos2, &collisionPoint);
    }
    [[nodiscard]] bool CheckCollisionLines(::Vector2 endPos1, ::Vector2 startPos2, ::Vector2 endPos2) const noexcept {
     ...
     */
    [[nodiscard]] bool
    CheckCollisionPointLine(::Vector2 p1, ::Vector2 p2, int threshold = DefaultCheckCollisionPointLineThreshold) const {
