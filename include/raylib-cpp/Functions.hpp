...
#ifdef RAYLIB_CPP_EXPECTED
[[maybe_unused]] RLCPPAPI inline RAYLIB_CPP_EXPECTED_RESULT(AudioDevice) InitAudioDevice() {
    AudioDevice ret;
...
#ifdef RAYLIB_CPP_EXPECTED
[[maybe_unused]] RLCPPAPI inline RAYLIB_CPP_EXPECTED_RESULT(AutomationEventList) LoadAutomationEventList(const std::filesystem::path& fileName) {
