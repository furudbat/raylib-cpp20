...
class Vector2 : public ::Vector2 {
 public:
     ...
     */
    [[nodiscard]] Vector2 Divide(const float div) const {
     ...
     */
    [[nodiscard]] Vector2 Transform(::Matrix mat) const {
     ...
     */
    [[nodiscard]] Vector2 Lerp(const ::Vector2& vector2, float amount) const {
